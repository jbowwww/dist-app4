 ...
 */
module.exports = function standardSchemaPlugin(schema, trackedMethods) {

	schema.plugin(stat, trackedMethods.instance);
	trackedMethods.instance.forEach(function(methodName) {
